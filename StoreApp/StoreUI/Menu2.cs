...
namespace StoreUI
{
    ...
    public class Menu2 : IMenu
    {
        ...
        public Menu2(ICustomerBL customerBL)
        {
        ...
        public void AddNewCustomer()
        {
            ...
            StartShopping(newCustomer.Orders);
        }
        public void SearchCustomers()
        {
            ...
            foreach (var item in _customerBL.GetCustomers())
            {
                if (item.CustomerName.ToLower() == userInputName.ToLower())
                {
                    ...
                    StartShopping(item.Orders);
                }
            }
            Console.WriteLine($"Customer {userInputName} was not found.");
            Start();
        }
        public void StartShopping(Orders prevOrders)
        {
            bool stayMainMenu = true;
        ...
        public void ViewPreviousOrders(Orders prevOrders)
        {
